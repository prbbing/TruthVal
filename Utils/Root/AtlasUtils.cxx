...
TGraphErrors* myTGraphErrorsDivide(TGraphErrors* g1,TGraphErrors* g2) {
  ...
  if (debug) printf("**myTGraphErrorsDivide: n1=%d  n2=%d !  \n",n1,n2);
...
// void myText(double x,double y,Color_t color,char *text,double tsize ) {
...
// void myTextBold(double x,double y,Color_t color,char *text,double tsize ) {
...
// void myMarkerText(double x,double y,int color,int mstyle,char *text,Float_t msize) 
// {
//   double tsize=0.06;
